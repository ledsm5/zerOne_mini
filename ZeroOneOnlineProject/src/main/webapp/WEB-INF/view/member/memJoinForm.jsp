...
<body>
<h1 style="text-align: center;">zerone</h1>
<form:form action="memJoinAction" method="post" name="frm" modelAttribute="memberCommand" > <!--  modelAttribute="memberCommand"  뭐하는친구?-->
	<table border = 1 align="center">
		...
		<tr>
			<td>주소</td>
			<td><form:input path="memAddress" id="sample4_roadAddress" readonly="readonly" size="30"/><a href="javascript:sample4_execDaumPostcode();">주소 검색</a>
